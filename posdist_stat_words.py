...
def diff_vwords_vlens(wordlist,corpus_pkl,start_len,end_len,bandwidth):
	...
	print(f'Mean: {word_kl_means_mean}')
	print(f'SD: {word_kl_stds_mean}')
...
def diff_vlens_vwords(wordlist,corpus_pkl,start_len,end_len,bandwidth):
	...
	print(f'Mean: {kl_mean_means}')
	print(f'SD: {kl_mean_stds}')
...
if __name__ == '__main__':
	...
	corpus_dir = Path(sys.argv[4])
	wordlist = sys.argv[5].split()
	corpus = corpus_loader(corpus_dir)
	res = diff_vlens_vwords(wordlist,corpus,start_len,end_len,bandwidth)
