...
ax.plot([i for i in range(1,14)], and_attn_row_h0310_12_mean, label='12', marker='+', fillstyle='none', linewidth=1, linestyle=(0,(7,0)))
ax.plot([i for i in range(1,18)], and_attn_row_h0310_16_mean, label='16', marker='x', fillstyle='none', linewidth=1, linestyle=(0,(7,1)))
ax.plot([i for i in range(1,22)], and_attn_row_h0310_20_mean, label='20', marker='D', fillstyle='none', linewidth=1, linestyle=(0,(7,2)))
ax.plot([i for i in range(1,26)], and_attn_row_h0310_24_mean, label='24', marker='s', fillstyle='none', linewidth=1, linestyle=(0,(7,3)))
ax.plot([i for i in range(1,30)], and_attn_row_h0310_28_mean, label='28', marker='o', fillstyle='none', linewidth=1, linestyle=(0,(7,4)))
ax.plot([i for i in range(1,34)], and_attn_row_h0310_32_mean, label='32', marker='^', fillstyle='none', linewidth=1, linestyle=(0,(7,5)))
ax.plot([i for i in range(1,38)], and_attn_row_h0310_36_mean, label='36', marker='v', fillstyle='none', linewidth=1, linestyle=(0,(7,6)))
