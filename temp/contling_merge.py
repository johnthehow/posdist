...
ax.plot([i for i in range(1,14)], and_attn_row_h0301_12_mean, label='12', marker='+')
ax.plot([i for i in range(1,18)], and_attn_row_h0301_16_mean, label='16', marker='x')
ax.plot([i for i in range(1,22)], and_attn_row_h0301_20_mean, label='20', marker='D')
ax.plot([i for i in range(1,26)], and_attn_row_h0301_24_mean, label='24', marker='s')
ax.plot([i for i in range(1,30)], and_attn_row_h0301_28_mean, label='28', marker='o')
ax.plot([i for i in range(1,34)], and_attn_row_h0301_32_mean, label='32', marker='^')
ax.plot([i for i in range(1,38)], and_attn_row_h0301_36_mean, label='36', marker='v')
...
ax.plot([i for i in range(1,14)], and_attn_row_0310_12_mean, label='12', marker='+')
ax.plot([i for i in range(1,18)], and_attn_row_0310_16_mean, label='16', marker='x')
ax.plot([i for i in range(1,22)], and_attn_row_0310_20_mean, label='20', marker='D')
ax.plot([i for i in range(1,26)], and_attn_row_0310_24_mean, label='24', marker='s')
ax.plot([i for i in range(1,30)], and_attn_row_0310_28_mean, label='28', marker='o')
ax.plot([i for i in range(1,34)], and_attn_row_0310_32_mean, label='32', marker='^')
ax.plot([i for i in range(1,38)], and_attn_row_0310_36_mean, label='36', marker='v')
