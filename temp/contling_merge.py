...
ax.plot([i+1 for i in range(16)], and_attn_row_h0301_16_mean, label='16')
ax.plot([i+1 for i in range(20)], and_attn_row_h0301_20_mean, label='20')
ax.plot([i+1 for i in range(24)], and_attn_row_h0301_24_mean, label='24')
ax.plot([i+1 for i in range(28)], and_attn_row_h0301_28_mean, label='28')
ax.plot([i+1 for i in range(32)], and_attn_row_h0301_32_mean, label='32')
ax.plot([i+1 for i in range(36)], and_attn_row_h0301_36_mean, label='36')
